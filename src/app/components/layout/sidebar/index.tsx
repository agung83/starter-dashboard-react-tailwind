...
export const Sidebar = ({ statusSidebar }: SidebarType) => {
    return (
        <>
            <aside id="sidebar" className="bg-white shadow-xl dark:bg-gray-800 border-r-2 dark:border-blue-300 w-1/2 md:w-1/6 lg:w-1/6 md:h-screen lg:h-screen  hidden md:block lg:block md:overflow-y-scroll lg:overflow-y-scroll ">
