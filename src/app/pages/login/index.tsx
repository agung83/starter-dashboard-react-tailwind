...
interface TypeStateAuth {
    tryLogin: () => {}
}

export const Login = ({ tryLogin }: TypeStateAuth) => {
    ...
    return (
        <div className="relative min-h-screen flex ">
            <div
                ...
                <div
                    className="md:flex md:items-center md:justify-center w-full sm:w-auto md:h-full md:w-2/5 xl:w-2/5 sm:rounded-lg md:rounded-none bg-white">
                    <div className="max-w-md w-full space-y-8">
                        ...
                        <form className="mt-8 space-y-6">
                            <input type="hidden" name="remember" defaultChecked={true} />
                            <div className="relative">
                                <div className="absolute right-3 mt-4"><svg xmlns="http://www.w3.org/2000/svg"
                                ...
                                <input
                                    ...
                                    type="" placeholder="mail@gmail.com" defaultValue="mail@gmail.com" />
                            </div>
                            <div className="mt-8 content-center">
                                ...
                                <input
                                    ...
                                    type="" placeholder="Enter your password" defaultValue="*****|" />
                            </div>
                            ...
                            <div>
                                <button type="button" onClick={prosesOnLogin}
                                    className="w-full flex justify-center bg-gradient-to-r from-indigo-500 to-blue-600  hover:bg-gradient-to-l hover:from-blue-500 hover:to-indigo-600 text-gray-100 p-4   tracking-wide font-semibold  shadow-lg cursor-pointer transition ease-in duration-500">
                                    Sign in
                                </button>
                            </div>
